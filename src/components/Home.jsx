          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-4 text-justify">
                Welcome to Cihampelas Hotel Group. It consists of three
                luxurious, nice and clean hotels where you can spend your
                holiday in comfort at an affordable rate. Strategically located
                in the Central of Bandung, Cihampelas Hotel 1 and 2 are highly
              ...
              <p className="text-gray-600 leading-relaxed mb-6 text-justify">
                ...
                District, within walking distance to the Shopping Complex and
                very near to famous Factory Outlets.
              </p>
              <a
                href="/about"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="group p-8 rounded-3xl shadow-md bg-white border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Located in the heart of Bandung, close to shopping, dining,
              ...
              <div className="group p-8 rounded-3xl shadow-md bg-white border border-gray-100 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                ...
                <p className="text-gray-600">
                  Enjoy premium services and facilities at budget-friendly
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="text-center mb-10 md:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-xl md:max-w-2xl mx-auto">
                Discover why thousands of guests choose Cihampelas Hotel for
                their perfect stay
              </p>
            </div>
        ...
        <section className="py-20 bg-yellow-600 text-center text-white relative overflow-hidden">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <p className="text-lg leading-relaxed">
              ...
              getaway, our warm service and strategic location will make your
              stay unforgettable.
            </p>
          </div>
        </section>
